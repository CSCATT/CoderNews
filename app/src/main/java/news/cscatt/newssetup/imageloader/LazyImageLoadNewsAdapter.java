package news.cscatt.newssetup.imageloader;
...
public class LazyImageLoadNewsAdapter extends BaseAdapter implements
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.text = (TextView) vi.findViewById(R.id.textView3);
		...
		Log.d("LazyImageLoad", item.getNews_title());
	...
	private class OnItemClickListener implements OnClickListener {
		...
		public void onClick(View arg0) {
			...
			Intent myIntent = new Intent(mContext, ReadNewsActivity.class);
